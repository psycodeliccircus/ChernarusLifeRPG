...
switch (_vehicle) do
{
	...
	case "C_Offroad_01_F":
	{
		...
		[
			...
			["textures\UN\offroad_01_ext_gov_co.paa","cop"],
			["#(argb,8,8,3)color(0.6,0.3,0.01,1)","civ"],
			["Textures\medic\Vehicles\pickup_medic.jpg","med"]
		];
	};
	...
	case "C_SUV_01_F":
	{
		...
		[
			...
			["Textures\medic\Vehicles\suv_medic.paa","med"]
		];
	};
	...
	case "B_Heli_Light_01_F":
	{
		...
		[
			...
			["Textures\medic\Vehicles\heli_med.paa","med"]
	...
	case "O_Heli_Light_02_unarmed_F":
	{
		...
		[
			...
			["#(argb,8,8,3)color(1,1,1,0.8)","med"],
			["Textures\medic\Vehicles\heli2_med.paa","med"]
	...
	case "I_MRAP_03_F":
	{
		_ret = 
		[
			["textures\UN\mrap_03_ext_un_cm.paa","cop","textures\UN\mrap_03_ext_un_co.paa"]
		];
	};
    ...
    case "I_Truck_02_covered_F":
	{
		_ret = 
		[
			["Textures\Civ\Vehicles\zamak_weed_back.jpg","civ"]
		];
	};
	...
	case "I_Heli_light_03_unarmed_F":
	{
		_ret = 
		[
			["Textures\Cop\Vehicles\copHellcat.paa","cop"]
