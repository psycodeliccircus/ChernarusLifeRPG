...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "militia": {_var = "license_civ_militia"}; //Rebel License
            ...
            case "donorone": {_var = "license_civ_donorone"}; //Normal Donator
            case "donortwo": {_var = "license_civ_donortwo"}; //Super Donator
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_militia": {_var = "militia"}; //militia License
