...
player createDiarySubject ["UNrules","UN Rules"];
...
// Police Section
	player createDiaryRecord ["UNrules",
		[
			"Crisis Negotiation",
				"
	...
	player createDiaryRecord ["UNrules",
		[
			"The Federal Reserve",
				...
				5. UN may not fire blindly into the building.<br/>
				6. The UN should evacuate the civilians from the building during a robbery.<br/>
				7. Any civilian who actively makes an attempt to block the UN from entering the building may be treated as an accomplice.<br/>
	...
	player createDiaryRecord ["UNrules",
		[
			"Aviation",
				...
				3. UN may temporarily forbid landing at  but it cannot remain closed for a long period of time.<br/>
				4. Helicopters cannot fly below 150m over the city without authorization.<br/>
				5. Helicopters cannot hover over the city. UN may only hover over the city if there is an active UN operation going on.<br/><br/>
	...
	player createDiaryRecord ["UNrules",
		[
			"Illegal Areas", 
				"
				1. Gang areas are not considered illegal. Thus a UN may enter without a raid, but may not restrain or stop anyone inside without probable cause/illegal activity. (Talking to the gang NPC is NOT probable cause/illegal activity.)<br/>
	...
	player createDiaryRecord ["UNrules",
		[
			"Patrolling", 
				"
				1. UN may patrol the island's roads and towns searching for abandoned vehicles and criminal activity.<br/>
	...
	player createDiaryRecord ["UNrules",
		[
			"Vehicles", 
				...
				5. Impounding is an essential job for a UN, it helps keep the server clean and less laggy.<br/>
				6. If in doubt, always search the vehicle and message the owner(s) before impounding.<br/>
				7. UN speedboats or Hunter HMGs may be used to assist in apprehending criminals. The weapon should be used to disable vehicles, not to blow them up.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["UNrules",
		[
			"Speeding", 
				"
				The following speeds are to be enforced by the UN for the absolute safety of the citizens of Chernarus.<br/><br/>
	...
	player createDiaryRecord ["UNrules",
		[
			"City Protocol", 
				"
				1. Officers may patrol major cities.<br/>
				...
				6. The UN HQ buildings are illegal for civilians to enter without authorization, however it is NOT illegal for civilians to be nearby unless they are causing a nuisance.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["UNrules",
		[
			"Arresting",
				...
				4. Refusal to pay a legit ticket is grounds for arrest.<br/>
				"
		]
	];
	...
	player createDiaryRecord ["UNrules",
		[
			"Raiding/Camping",
				"
				Raiding is defined as a squad of UN officers invading an area of high criminal activity in order to stop the criminals in illegal acts.<br/><br/>
	...
	player createDiaryRecord ["UNrules",
		[
			"Chain of Command",
				"
				The highest ranking officer on duty is in charge of the UN outside of admins currently online. The high ranking officer is expected to follow the rules and guidelines of his/her rank, and must report to the admin in case any action need be taken.<br/><br/>

				UN Chain of Command:<br/>
				1. General<br/>
				2. Major<br/>
				3. Captain<br/>
				4. Lieutenant<br/>
				...
				UN in game who are not enrolled/accepted into the SPD are the lowest tier and have no say in police operations.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["UNrules",
		[
			"Teamspeak Rule",
				"
				1. All cops must be on Teamspeak 3 in a designated UN channel. Failure to be on Teamspeak during an admin check will result in your immediate dismissal from the server.<br/>
				2. Please join Teamspeak BEFORE you spawn in as a UN, heck, join Teamspeak before you even join the server.<br/><br/>
				"
		]
	];
...
// Illegal Items Section
	player createDiaryRecord ["illegalitems",
		[
			"Militia Rules",
				"
				A Militia Member is one who rises in armed resistance against a government. In this case it would be the UN. However, due to the small amount of UN compared to the possible amount of Militia Members, do not attack the UN without a reason, please be civil and use common sense, and don't take the word Militia Member literally, but instead how it will make this server fun for all.<br/><br/>
				1. A Militia Member must first form a gang, and then declare intentions.<br/>
				2. Resistance does not excuse RDMing (See RDMing in General Rules)<br/>
				3. Resistance roleplay should be conducted in more ways than constantly robbing the bank or shooting UN officers.<br/>
	...
	player createDiaryRecord ["illegalitems",
		[
			"Illegal Vehicles",
				"
				All armed vehicles are illegal for civillians to own!<br/><br/>
                                "
		]
	];
	player createDiaryRecord ["illegalitems",
